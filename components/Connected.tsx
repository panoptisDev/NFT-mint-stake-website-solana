...
const Connected: FC = () => {
  ...
  return (
    <VStack spacing={20}>
      <Container>
        <VStack spacing={8}>
          <Heading color="white" as="h1" size="2xl" noOfLines={1} textAlign="center"> Welcome My Wellow Willow.</Heading>
          <Text color="bodyText" fontSize="xl" textAlign="center">Each Willow is randomly generated and can be staked to receive<Text as="b"> WLW</Text>. Use your <Text as="b"> WLW</Text> to upgrade your Willow and receive perks within the community!</Text>
        </VStack>
      </Container>
